...
exports.register = async (data) => {
  ...
  //Evitar crear un usuario con nombre de usuario ya existente
  const userExists = await Usuario.findOne({username:data.username});
  if(userExists){
    respuesta.creado = false;
    respuesta.error = "Ya existe un usuario con ese nombre de usuario";
    return respuesta;
  }
  const userData = {
